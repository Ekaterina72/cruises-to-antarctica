...
/* harmony import */ var _modules_header_sticky_header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/header/sticky-header */ "./js/modules/header/sticky-header.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    burger.init();
    var stickyHeader = new _modules_header_sticky_header__WEBPACK_IMPORTED_MODULE_3__["StickyHeader"]();
    stickyHeader.init();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_1__["Form"]();
    window.form = form;
    form.init();
    Object(_modules_map_map__WEBPACK_IMPORTED_MODULE_4__["startMap"])();
  });
});
...
/*!*******************************!*\
  !*** ./js/modules/map/map.js ***!
  \*******************************/
/*! exports provided: startMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "startMap", function() { return startMap; });
var myMap = document.querySelector('#map');
var scriptLink = 'https://api-maps.yandex.ru/2.1/?apikey=7d566289-5540-4e2f-911d-b60b8a1f68a5&lang=ru_RU';
var initMap = function initMap() {
  var map = new window.ymaps.Map(myMap, {
    center: [59.93863106417265, 30.323036499999905],
    zoom: 16,
    controls: []
  });
  var myPlacemark = new window.ymaps.Placemark([59.937449374527226, 30.32259661772146], {}, {
...
var createMap = function createMap() {
  if (myMap) {
    ...
    mapScriptElement.onload = function () {
